...
class administration(object):
    ...
    def create_user(self, username, password, email, org=None):
        ...
        user = wait_until_element(self.base.driver, "//div[contains(@title, '%s')]" % username, By.XPATH)
        asserts.fail_unless_none(user, "A user with this name already exists.")

        # New User link
        new_user_link = wait_until_element(self.base.driver, "//div[@id='list-title']/header/a", By.XPATH)
        asserts.fail_if_none(new_user_link, "Could not find the New User link.")
        new_user_link.click()

        # Fill out the form
        # Username
        user_name_field = wait_until_element(self.base.driver, "//form[@id='new_user']/fieldset/div[2]/input", By.XPATH)
        asserts.fail_if_none(user_name_field, "Could not find the username field.")
        user_name_field.send_keys(username)
        # Password
        password_field = wait_until_element(self.base.driver, "//form[@id='new_user']/fieldset[2]/div[2]/input", By.XPATH)
        asserts.fail_if_none(password_field, "Could not find the password field.")
        password_field.send_keys(password)
        # Password confirmation
        password_confirmation_field = wait_until_element(self.base.driver, "//form[@id='new_user']/fieldset[3]/div[2]/input", By.XPATH)
        ...
        # Email
        email_field = wait_until_element(self.base.driver, "//form[@id='new_user']/fieldset[4]/div[2]/input", By.XPATH)
        asserts.fail_if_none(email_field, "Could not find the email field.")
        email_field.send_keys(email)

        if org:
            orgs_list = wait_until_element(self.base.driver, "//form[@id='new_user']/fieldset[5]/div[2]/select", By.XPATH)
    ...
    def delete_user(self, username):
        ...
        # Remove user link
        remove_user_link = wait_until_element(self.base.driver, "//div[@id='panel']/div/div[2]/div/a", By.XPATH)
    ...
    def add_role_to_user(self, role_name, username):
        ...
        roles_link = wait_until_element(self.base.driver, "//div/div[2]/nav/ul/li[2]/a", By.XPATH)
        ...
        # Save
        submit_button = wait_until_element(self.base.driver, "//form[@id='update_roles']/div[3]/div/input[2]", By.XPATH)
    ...
    def create_role(self, role_name):
        ...
        role = wait_until_element(self.base.driver, "//span[contains(., '%s')]" % role_name, By.XPATH)
        asserts.fail_unless_none(role, "A role with this name already exists.")

        # New Role link
        new_role_link = wait_until_element(self.base.driver, "//div[@id='list-title']/header/a", By.XPATH)
        asserts.fail_if_none(new_role_link, "Could not find the New Role link.")
        new_role_link.click()

        # Role name field
        role_name_field = wait_until_element(self.base.driver, "//form[@id='new_role']/fieldset/div[2]/input", By.XPATH)
        asserts.fail_if_none(role_name_field, "Could not find the role name field.")
        role_name_field.send_keys(role_name)

        # Submit button
        submit_button = wait_until_element(self.base.driver, "//form[@id='new_role']/div[2]/div/input", By.XPATH)
    ...
    def delete_role(self, role_name):
        ...
        remove_button = wait_until_element(self.base.driver, "//div[@id='remove_role']/span[2]", By.XPATH)
    ...
    def add_permission_to_role(self, role_name, permission_level, permission_type, verb, permission_name):
        ...
        # Permissions section
        permissions = wait_until_element(self.base.driver, "//div[@id='role_permissions']/span", By.XPATH)
        permissions.click()

        # Select the permission type
        selected_permission = wait_until_element(self.base.driver, "//div[@id='%s']/span" % permission_level, By.XPATH)
        selected_permission.click()

        # Add new permission button
        add_button = wait_until_element(self.base.driver, "//div[@id='add_permission']/span[2]", By.XPATH)
        add_button.click()

        # Select the permission type
        permissions_list = wait_until_element(self.base.driver, "//div[@id='resource_type_container']/select", By.XPATH)
        Select(permissions_list).select_by_visible_text("%s" % permission_type)

        next_button = wait_until_element(self.base.driver, "//div[@id='permission_button_bar']/div[2]", By.XPATH)
        next_button.click()

        # All Verbs
        verbs = wait_until_element(self.base.driver, "//select[@id='verbs']", By.XPATH)
        ...
        # New permission name
        permission_name_field = wait_until_element(self.base.driver, "//div[@id='details_container']/input", By.XPATH)
        permission_name_field.send_keys("%s" % permission_name)

        # Save
        save_button = wait_until_element(self.base.driver, "//div[@id='permission_button_bar']/div[3]", By.XPATH)
        save_button.click()
