...
BOOKMARK_ENTITIES = [
    {'name': 'ActivationKey', 'controller': 'activation_keys'},
    {'name': 'Dashboard', 'controller': 'dashboard'},
    {'name': 'Fact', 'controller': 'fact_values'},
    {'name': 'Audit', 'controller': 'audits'},
    {'name': 'Report', 'controller': 'config_reports'},
    {'name': 'Task', 'controller': 'tasks_foreman_tasks'},
    {'name': 'Subscription', 'controller': 'katello_subscriptions'},
    ...
    {'name': 'Errata', 'controller': 'katello_erratum'},
    ...
    {'name': 'Registry', 'controller': 'registries'},
    {'name': 'Host', 'controller': 'katello_hosts',
        'setup': entities.Host},
    {'name': 'ContentHost', 'controller': 'katello_systems'},
    {'name': 'HostCollection', 'controller': 'katello_host_collections'},
    {'name': 'Architecture', 'controller': 'katello_architectures'},
    {'name': 'HWModel', 'controller': 'models'},
    {'name': 'InstallationMedia', 'controller': 'media',
        'setup': entities.Media},
    {'name': 'OS', 'controller': 'operatingsystems'},
    {'name': 'PTable', 'controller': 'ptables',
        'setup': entities.PartitionTable},
    {'name': 'ProvisioningTemplate', 'controller': 'provisioning_templates'},
    {'name': 'HostGroup', 'controller': 'host_groups',
    ...
    {'name': 'PuppetClass', 'controller': 'puppet_classes',
        'setup': entities.PuppetClass},
    {'name': 'SmartVariable', 'controller': 'smart_variables',
        'setup': entities.SmartVariable},
    {'name': 'SmartProxy', 'controller': 'smart_proxies'},
    ...
    {'name': 'Domain', 'controller': 'domains',
        'setup': entities.Domain},
    ...
    {'name': 'UserGroup', 'controller': 'user_groups',
