...
VALID_GCE_ZONES = [
    f"{loc}-{zone}" for loc, zones in _zones_combo.items() for zone in zones
]
...
REPOSET = {
    ...
    "rhst7": "Red Hat Satellite Tools 6.6 (for RHEL 7 Server) (RPMs)",
...
REPOS = {
    ...
    "rhdt7": {
        "name": (
            "Red Hat Developer Tools RPMs for Red Hat Enterprise Linux 7"
            " Server x86_64"
        ),
    },
    "rhscl7": {
...
CUSTOM_RPM_SHA_512 = (
    "https://repos.fedorapeople.org/pulp/pulp/fixtures/rpm-with-sha-512/"
)
...
CUSTOM_MODULE_STREAM_REPO_2 = (
    "https://partha.fedorapeople.org/test-repos/rpm-with-modules/el8/"
)
...
FAKE_7_YUM_REPO = (
    "https://repos.fedorapeople.org/pulp/pulp/demo_repos/large_errata/zoo/"
)
...
FAKE_YUM_SRPM_DUPLICATE_REPO = (
    "https://repos.fedorapeople.org/pulp/pulp/fixtures/srpm-duplicate/"
)
...
FEDORA26_OSTREE_REPO = (
    "https://kojipkgs.fedoraproject.org/compose/ostree-20190207-old/26/"
)
FEDORA27_OSTREE_REPO = (
    "https://kojipkgs.fedoraproject.org/compose/ostree-20190207-old/27/"
)
...
FAKE_4_CUSTOM_PACKAGE = "kangaroo-0.3-1.noarch"
...
BOOKMARK_ENTITIES = [
    ...
    {
        "name": "PuppetModule",
        "controller": "katello_puppet_modules",
        "skip_for_ui": True,
    },
    {
    ...
    {
        "name": "PuppetEnvironment",
        "controller": "environments",
        "setup": entities.Environment,
    },
    {
        "name": "PuppetClass",
        "controller": "puppetclasses",
...
TOOLS_ERRATA_DETAILS = [
    ...
    [
        "Topic",
        "Red Hat Satellite 6.2 now available for Red Hat Enterprise Linux 6 " "and 7",
    ],
