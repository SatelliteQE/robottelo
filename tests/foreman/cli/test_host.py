...
@pytest.mark.host_create
@pytest.mark.tier3
def test_positive_list(module_ak_with_cv, module_lce, module_org, rhel7_contenthost, target_sat):
...
@pytest.mark.tier3
def test_positive_tracer_list_and_resolve(katello_host_tools_tracer_host):
