...
def test_negative_check_katello_reimport(target_sat, function_org):
    """Verify katello:reimport fails with Error
    ...
    :steps:
        ...
        3. Re-import new manifest & refresh

    :expectedresults: there should not an error after reimport manifest
    ...
    assert (
        "Manifest refresh failed:\n  The manifest doesn\'t exist on console.redhat.com." in ret_val
    )
