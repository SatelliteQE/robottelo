...
class TestRenameHost:
    ...
    @pytest.mark.destructive
    def test_positive_rename_satellite(self, module_org, module_product, module_target_sat):
    ...
    @pytest.mark.destructive
    def test_negative_rename_sat_to_invalid_hostname(self, module_target_sat):
    ...
    @pytest.mark.destructive
    def test_negative_rename_sat_no_credentials(self, module_target_sat):
    ...
    @pytest.mark.destructive
    def test_negative_rename_sat_wrong_passwd(self, module_target_sat):
    ...
    @pytest.mark.stubbed
    @pytest.mark.destructive
    def test_positive_rename_capsule(self, module_target_sat):
