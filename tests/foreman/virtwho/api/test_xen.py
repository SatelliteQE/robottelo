...
def form_data(default_org):
    form = {
        ...
        'hypervisor_server': settings.virtwho.xen.hypervisor_server,
        'organization_id': default_org.id,
        'filtering_mode': 'none',
        'satellite_url': settings.server.hostname,
        'hypervisor_username': settings.virtwho.xen.hypervisor_username,
        'hypervisor_password': settings.virtwho.xen.hypervisor_password,
    }
    return form
