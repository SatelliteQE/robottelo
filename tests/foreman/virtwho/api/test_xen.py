...
def form_data(default_org):
    form = {
        ...
        'hypervisor_server': virtwhosettings.xen.hypervisor_server,
        'organization_id': default_org.id,
        'filtering_mode': 'none',
        'satellite_url': settings.server.hostname,
        'hypervisor_username': virtwhosettings.xen.hypervisor_username,
        'hypervisor_password': virtwhosettings.xen.hypervisor_password,
    }
    return form
