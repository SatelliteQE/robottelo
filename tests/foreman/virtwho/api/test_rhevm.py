...
def form_data(default_org):
    form = {
        ...
        'hypervisor_server': virtwho.rhevm.hypervisor_server,
        'organization_id': default_org.id,
        'filtering_mode': 'none',
        'satellite_url': settings.server.hostname,
        'hypervisor_username': virtwho.rhevm.hypervisor_username,
        'hypervisor_password': virtwho.rhevm.hypervisor_password,
    }
    return form
