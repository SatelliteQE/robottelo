...
def form_data():
    form = {
        ...
        'hypervisor_type': virtwho.libvirt.hypervisor_type,
        'hypervisor_content.server': virtwho.libvirt.hypervisor_server,
        'hypervisor_content.username': virtwho.libvirt.hypervisor_username,
    }
    return form
