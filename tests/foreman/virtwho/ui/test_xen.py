...
def form_data():
    form = {
        ...
        'hypervisor_type': settings.virtwho.xen.hypervisor_type,
        'hypervisor_content.server': settings.virtwho.xen.hypervisor_server,
        'hypervisor_content.username': settings.virtwho.xen.hypervisor_username,
        'hypervisor_content.password': settings.virtwho.xen.hypervisor_password,
    }
    return form
