...
def form_data():
    form = {
        ...
        'hypervisor_content.server': virtwhosettings.rhevm.hypervisor_server,
        'hypervisor_content.username': virtwhosettings.rhevm.hypervisor_username,
        'hypervisor_content.password': virtwhosettings.rhevm.hypervisor_password,
    }
    return form
