...
def form_data():
    form = {
        ...
        'hypervisor-type': virtwhosettings.rhevm.hypervisor_type,
        'hypervisor-server': virtwhosettings.rhevm.hypervisor_server,
        'organization-id': 1,
        'filtering-mode': 'none',
        'satellite-url': settings.server.hostname,
        'hypervisor-username': virtwhosettings.rhevm.hypervisor_username,
        'hypervisor-password': virtwhosettings.rhevm.hypervisor_password,
    }
    return form
