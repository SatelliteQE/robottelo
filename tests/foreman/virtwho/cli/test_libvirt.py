...
def form_data():
    form = {
        ...
        'hypervisor-type': virtwhosettings.libvirt.hypervisor_type,
        'hypervisor-server': virtwhosettings.libvirt.hypervisor_server,
        'organization-id': 1,
        'filtering-mode': 'none',
        'satellite-url': settings.server.hostname,
        'hypervisor-username': virtwhosettings.libvirt.hypervisor_username,
    }
    return form
