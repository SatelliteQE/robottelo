...
PREVIOUS_INSTALLER_OPTIONS = set([
    ...
    u'--foreman-proxy-content-pulp-max-tasks-per-child',
    ...
    u'--foreman-proxy-plugin-dhcp-infoblox-use-ranges',
    ...
    u'--foreman-proxy-puppetca-modular',
    ...
    u'--reset-foreman-proxy-content-pulp-max-tasks-per-child',
    ...
    u'--reset-foreman-proxy-plugin-dhcp-infoblox-use-ranges',
    ...
    u'--reset-foreman-proxy-puppetca-modular',
