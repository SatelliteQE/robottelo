...
PREVIOUS_INSTALLER_OPTIONS = set(
    [
        ...
        u'--foreman-proxy-plugin-ansible-install-runner',
        u'--foreman-proxy-plugin-ansible-manage-runner-repo',
        u'--foreman-proxy-plugin-ansible-roles-path',
        ...
        u'--foreman-proxy-plugin-ansible-ssh-args',
        ...
        u'--migrations-only',
        u'--noop',
        u'--[no-]enable-foreman-cli-ansible',
        u'--[no-]enable-foreman-cli-azure',
        u'--[no-]enable-foreman-cli-virt-who-configure',
        u'--[no-]enable-foreman-plugin-azure',
        u'--[no-]enable-foreman-plugin-inventory-upload',
        u'--[no-]enable-foreman-plugin-remote-execution-cockpit',
        u'--[no-]enable-foreman-plugin-virt-who-configure',
        u'--profile',
        ...
        u'--reset-foreman-proxy-plugin-ansible-install-runner',
        u'--reset-foreman-proxy-plugin-ansible-manage-runner-repo',
        u'--reset-foreman-proxy-plugin-ansible-roles-path',
        u'--reset-foreman-proxy-plugin-ansible-ssh-args',
...
class SELinuxTestCase(TestCase):
    ...
    def test_positive_check_installer_services(self):
        ...
        result = ssh.command(
            u'hammer -u {0[0]} -p {0[1]} ping'.format(settings.server.get_credentials())
        )
