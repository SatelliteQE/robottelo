    ...
    def test_ccv_publish_dependency_chaining(self, module_target_sat, module_sca_manifest_org):
        ...
        :steps:
            ...
            5. Wait for the CCV publish task to be scheduled and wait until completed.
                It should be scheduled after the faster component CV publish task is completed.
        ...
        :expectedresults:
            1. CCV publish task is scheduled after the faster component CV publish task is completed.
