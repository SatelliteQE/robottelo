...
class TestHostGroupMissingAttr:
    ...
    @pytest.mark.tier2
    def test_positive_get_content_source(self, hostgroup, target_sat):
    ...
    @pytest.mark.tier2
    def test_positive_get_cv(self, hostgroup, target_sat):
        """Read a host group. Inspect the server's response.
    ...
    @pytest.mark.tier2
    def test_positive_get_lce(self, hostgroup, target_sat):
        """Read a host group. Inspect the server's response.
