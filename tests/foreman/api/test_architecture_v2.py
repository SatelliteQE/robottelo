...
class ArchitecturesTestCase(TestCase):
    ...
    def test_get_unauthorized(self):
        """@Test: GET ``api/v2/architectures`` without credentials.
    ...
    def test_post_unauthorized(self):
        """@Test: POST ``api/v2/architectures`` without credentials.
...
class ArchitecturesIdTestCase(TestCase):
    """Tests for path ``api/v2/architectures/:id``."""
    def setUp(self):  # pylint: disable=C0103
        """Set ``self.attrs`` and ``self.path``."""
        self.attrs = entities.Architecture().create()
        self.path = urljoin(
            get_server_url(),
            'api/v2/architectures/{0}'.format(self.attrs['id'])
        )

    def test_get(self):
        """@Test: GET ``api/v2/architectures/:id``.
    ...
    def test_delete(self):
        """@Test: DELETE ``api/v2/architectures/:id``.
