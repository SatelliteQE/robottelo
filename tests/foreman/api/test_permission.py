...
class TestPermission:
    ...
    def create_permissions(self, class_target_sat):
        ...
        if not class_target_sat.is_upstream:
            cls.permissions.pop('LookupValue')
        ...
        if 'orcharhino_core' in rpm_packages:
            cls.permissions[None].extend(cls.permissions.pop('OrcharhinoCore'))
        else:
            cls.permissions.pop('OrcharhinoCore')
