...
def test_positive_upload_host_facts(
    ...
    """Verify Facts option is available on the Host UI and it is successfully updated in Satellite after updated registration command.

    :id: f32093d2-4088-4025-9623-adb3141bd770

    :steps:
        1. Register host with updated command to Satellite.
        2. Navigate to the Host page and click on kebab.
        3. Verify that the facts option is available and is updated on Satellite.

    :expectedresults:
        1. The host is successfully registered using the label/name instead of the ID.
