...
def test_iop_recommendations_e2e(
    ...
    with module_target_sat_insights.ui_session() as session:
        ...
        result = session.recommendationstab.remediate_affected_systems(OPENSSH_RECOMMENDATION, rhel_insights_vm.hostname)
        ...
        # Verify that the recommendation is not listed anymore.
        assert 'No recommendations None of your connected systems are affected by enabled recommendations' in session.recommendationstab.search(OPENSSH_RECOMMENDATION)[0]['Name']
