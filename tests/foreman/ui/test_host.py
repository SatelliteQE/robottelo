...
def test_positive_change_org_loc_of_multi_hosts(
    new_host_ui, module_target_sat, content_hosts, function_org, function_location
):
    ...
    host_names = []
    for host in content_hosts[:2]:  # Use first 2 content hosts
    ...
    with module_target_sat.ui_session() as session:
        ...
        # Navigate to All Hosts page and perform bulk change
        session.all_hosts.change_organization_location(
            host_names=host_names,
        ...
        # Verify hosts appear in the new organization/location
        for host_name in host_names:
