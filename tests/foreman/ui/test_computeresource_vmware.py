...
@pytest.fixture
def get_vmware_datastore_cluster_summary_string(vmware, vmwareclient):
    """Return the datastore string summary for data_store_name
...
def test_positive_provision_end_to_end(
    ...
    get_vmware_datastore_cluster_summary_string,
):
    ...
    storage_data = {
        'storage': {'disks': [{'storage_pod': get_vmware_datastore_cluster_summary_string}]}
    }
    network_data = {
        'network_interfaces': {
            'nic_type': VMWARE_CONSTANTS['network_interface_name'],
