...
def test_synced_container_pullable_paths(
    ...
    :steps:
        ...
        3. Navigate to the Container Images feature.
        4. Read the pullable paths information for a manifest list in the Synced Containers table.
        4. Read the pullable paths information for a manifest list in it's Manifest Details page.
