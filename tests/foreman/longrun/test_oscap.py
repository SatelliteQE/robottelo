...
class OpenScapTestCase(UITestCase):
    ...
    @stubbed
    @tier4
    def test_arf_report_has_summary_page(self):
    ...
    @stubbed
    @tier4
    def test_view_full_report_button(self):
    ...
    @stubbed
    @tier4
    def test_download_xml_button(self):
    ...
    @stubbed
    @tier4
    def test_select_oscap_proxy(self):
    ...
    @stubbed
    @tier4
    def test_multiple_arf_report_deletion(self):
    ...
    @stubbed
    @tier4
    def test_email_reporting_of_oscap_reports(self):
