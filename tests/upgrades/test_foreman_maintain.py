...
class ScenarioForemanMaintain(TestCase):
    ...
    def satellite_upgradable_version_list():
        ...
        upgradeable_version = [version for version in forman_maintain_version.stdout
                               if version != '']
        version_change = 0
        ...
        if version_change % 2 == 0:
            ...
            y_version = list(set(forman_maintain_version) -
                             set(satellite_version))[0].split('.')[-1]

        return satellite_version, upgradeable_version, major_version_change, y_version

    @staticmethod
    def version_details(satellite_version, major_version_change, y_version,
                        upgrade_stage="pre-upgrade"):
        """
    ...
    def test_pre_foreman_maintain_upgrade_list_versions(self):
        ...
        :expectedresults: Versions should be current z-stream.
         ...
         """
        satellite_version, upgradable_version, major_version_change, y_version = \
        ...
        if satellite_version:
            ...
            zstream_version, next_version = self.version_details(satellite_version[0],
