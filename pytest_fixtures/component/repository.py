...
def module_repos_collection_with_setup(request, module_target_sat, module_org, module_lce):
    ...
    Remember:
        1. If you do not pass a repos request with valid 'distro' contained, we will attempt to fallback
        on any rhel_version parametrized by pytest markers, 'rhel_ver_match' or 'rhel_ver_list'.

    """
    # peek the first of globally scoped params,
    # if a RHEL host is parametrized, it will be at the top.
