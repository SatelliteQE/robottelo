...
def registered_contenthosts(request, target_sat, module_org, module_ak, module_cv, fake_yum_repos):
    ...
    Three custom repositories are synced & enabled initially, created in fixture fake_yum_repos.
    ...
    # Repositories (fixture: fake_yum_repos) already added to CV, not yet published.
